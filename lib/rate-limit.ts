 ...
 * NOTE: This is suitable for small-scale deployments. For production with multiple
 * serverless instances, use Vercel KV (Redis) or Upstash Redis for distributed rate limiting.
 */
